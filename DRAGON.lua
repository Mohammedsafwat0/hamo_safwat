...
io.popen("cd File_Bot && wget https://raw.https://github.com/Mohammedsafwat0/hamo_safwat/tree/main/File_Bot/commands.lua") 
...
os.execute('wget https://raw.https://github.com/Mohammedsafwat0/hamo_safwat/tree/main/DRAGON.lua')
...
if DevMohamed(msg) then
local Get_Files, res = https.request("https://raw.https://github.com/Mohammedsafwat0/hamo_safwat/tree/main/getfile.json")
if res == 200 then
...
local json_file, res = https.request("https://raw.https://github.com/Mohammedsafwat0/hamo_safwat/tree/main/File_Bot/"..file)
if res == 200 then
